...
class Instructor extends Lambdasian {
  constructor(inAtr) {
    super(inAtr);
    this.specialty = inAtr.specialty;
    this.favLanguage = inAtr.favLanguage;
    this.catchPhrase = inAtr.catchPhrase;
  } demo(subject) {
...
class Student extends Lambdasian {
  constructor(studAtr) {
    super(studAtr);
    this.previousBackground = studAtr.previousBackground
    this.className = studAtr.className;
    this.favSubjects = studAtr.favSubjects
  }
  listSubjects() {
